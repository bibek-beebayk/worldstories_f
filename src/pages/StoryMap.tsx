...
import { ChevronLeft, ChevronRight, Globe2, MapPinned, Minus, Plus, RotateCcw } from "lucide-react";
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 border-b px-4 py-3 sm:px-5">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Drag to pan, scroll or pinch to zoom, and tap a highlighted country to explore its titles.
                    </p>
                  </div>
                ...
                <div ref={mapContainerRef} className="relative bg-gradient-to-b from-sky-50/80 to-white p-1 sm:p-3">
                  ...
                  >
                    <button
                      ...
                      className="flex h-10 w-10 items-center justify-center text-slate-700 transition-colors hover:bg-sky-50 hover:text-sky-800 disabled:cursor-not-allowed disabled:opacity-40"
                      aria-label="Zoom in"
                    >
                    ...
                    <button
                      ...
                      className="flex h-10 w-10 items-center justify-center border-y border-slate-200 text-slate-700 transition-colors hover:bg-sky-50 hover:text-sky-800 disabled:cursor-not-allowed disabled:opacity-40"
                      aria-label="Zoom out"
                    >
