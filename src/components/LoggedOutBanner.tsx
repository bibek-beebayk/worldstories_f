...
// several features (Quick Read, favorites) are login-only, so this surfaces
// that up front rather than only when they hit a gate.
const LoggedOutBanner = () => {
  ...
  return (
    <div className="w-full bg-red-600 px-4 py-2 text-center text-sm font-medium text-white">
      ...
      to unlock favorites, Quick Read, and more.
    </div>
  );
};
