          ...
          >
            ...
            <CardContent className="pb-6 pt-6">
              ...
              <p className="mt-5 text-center text-xs text-muted-foreground">
                ...
                <Link to="/terms" className="font-medium text-primary hover:underline" onClick={() => setShowLoginModal(false)}>
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link to="/privacy" className="font-medium text-primary hover:underline" onClick={() => setShowLoginModal(false)}>
                  Privacy Policy
                </Link>
                .
              </p>
